...
namespace MG_BlocksEngine2.Horizontal.DragDrop
{
    // v2.12 - added class for drag Horizontal selection Function Blocks 
    public class BE2_DragHorizontalSelectionFunction : MonoBehaviour, I_BE2_Drag
    {
        ...
        public void OnDrag()
        {
            ...
            {
                if (item is BE2_BlockSectionHeader_Custom)
                {
                    BE2_BlockSectionHeader_Custom itemCustom = item as BE2_BlockSectionHeader_Custom;
                    ...
                    headerItem.serializableValue = itemCustom.serializableValue;
                }
