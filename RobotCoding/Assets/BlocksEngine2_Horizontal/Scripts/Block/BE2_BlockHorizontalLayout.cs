...
namespace MG_BlocksEngine2.Horizontal.Block
{
    ...
    public class BE2_BlockHorizontalLayout : MonoBehaviour, I_BE2_BlockLayout
    {
        ...
        void OnEnable()
        {
            // v1.5 - Blocks layout update is now executed by the execution manager
        ...
        // v1.5 - refactored the layout update to a coroutine to work being executed by the execution manager 
